...
<head>
  ...
  <title>Courses - Centre of Renaissance Pan-African Thought (CERPART)</title>
            ...
            <div class="course-item">
              ...
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <p class=" text-light">African Political Thought and Decolonial Praxis (Course Code: POA 701)
                    </p>
                  <p class="price">$169</p>
                </div>

                <h3><a href="course-details.html" class="btn category btn-success text-light"> View Course</a></h3>
                <div class="trainer d-flex justify-content-between align-items-center">
                  <div class="trainer-profile d-flex align-items-center">
                    <img src="assets/img/trainers/image1.jpeg" class="img-fluid" alt="">
