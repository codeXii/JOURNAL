...
<head>
  ...
  <title>Contact -Centre of Renaissance Pan-African Thought (CERPART)</title>
    ...
    <div class="page-title" data-aos="fade">
      <div class="heading">
        ...
        <?php if (isset($_SESSION['contact-success'])): ?>
              <div class="mt-4 bg-success text-center p-3">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="300">
              ...
              <div>
                <h3>Address</h3>
                <p>address of the organisation</p>
              </div>
            </div><!-- End Info Item -->
          ...
          <div class="col-lg-8">
            <form action="<?= ROOT_URL ?>email-logic.php" method="POST" class="" data-aos="fade-up" data-aos-delay="200">
              <div class="row gy-4">
